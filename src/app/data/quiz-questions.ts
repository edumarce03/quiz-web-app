export const QUIZ_QUESTIONS = {
  Ciencia: [
    ...
    },
    {
      ...
      options: ['Rayos gamma', 'Rayos X', 'Luz ultravioleta', 'Luz visible'],
      answer: 'Rayos gamma',
    },
  ],
  Historia: [
  ...
  Cine: [
    ...
    },
    {
      ...
      options: ['Parásitos', '1917', 'Joker', 'Once Upon a Time in Hollywood'],
      answer: 'Parásitos',
    },
    {
  ...
  Tecnología: [
    {
      question: '¿Qué compañía creó el sistema operativo Windows?',
